...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        #some variables for image slicing
        self.imageHeight = 0
        self.imageWidth = 0
        self.trainImagePath = ''
    ...
    def loadFile(self, filePath=None):
        ...
        #saving file path for slicing output
        self.trainImagePath = filePath
        print(filePath)
    ...
    def sliceDialog(self):
        self.getHeightX()
        self.show()

    def getHeightX(self):
        HeightX, okPressed1 = QInputDialog.getInt(self, "Enter Image Height","Height:", 512, 0, 4096, 1)
        if okPressed1:
            print(HeightX)
            self.imageHeight = HeightX
            self.getWidthY()

    def getWidthY(self):
        WidthY, okPressed2 = QInputDialog.getInt(self, "Enter Image Width","Width:", 512, 0, 4096, 1)
        if okPressed2:
            print(WidthY)
            self.imageWidth = WidthY
            self.startslicing()

    def startslicing(self):
        buttonReply = QMessageBox.question(self, 'Attention', "Start Image Slicing Now?",
